/*
© Anthrino > DHCP Config Snapshot Manager
*/
...
/*Method to generate readable time format from digital timestamp */
...
router.post('/', authorize.auth, function (req, res, next) {
    ...
    try {
        ...
        var bkp_dir = 'config_backups/' + global.anterius_config.current_server;
        ...
        if (request.mode == 'save') {
            ...
            var dhcp_config_file = JSON.parse(request.dhcp_config_file);
